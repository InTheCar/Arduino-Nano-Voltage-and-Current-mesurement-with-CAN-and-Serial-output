...
unsigned int Strom_gemessen = 0;         //Wert einfügen und bei 0 anfangen zu zählen
...
void loop() {
 ...
 Strom_umgerechnet=map(Strom_gemessen, 0, 1023, -5000, 5000);
 //Strom_umgerechnet=map(Strom_gemessen, -5000, 5000, 0, 1023);
